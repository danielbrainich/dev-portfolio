                        ...
                        <div className="col d-flex flex-column align-items-center p-3">
                            <div className="pt-1">
                                <a className="pe-2" href="https://www.danielbrainich.com">
                                    <span className="material-symbols-outlined white-outline">home</span></a>
                                <a className="p-2" href="https://www.linkedin.com/in/danielbrainich">
                                    <svg className="icon-footer" width="20" height="23" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" viewBox="0 0 24 24" id="linkedin">
                                ...
                                <a className="p-2" href="https://www.github.com/danielbrainich">
                                    <svg className="icon-footer" data-name="Layer 1"  width="23" height="23" viewBox="0 0 24 24" id="github">
                                ...
                                <a className="p-2" href="mailto: danielbrainich@gmail.com">
                                    <span className="material-symbols-outlined white-outline">mail</span>
                                </a>
                        </div>
