        ...
        <section className="d-flex" id="about-me">
            <div className="container d-flex flex-column align-items-between justify-content-center">
                <div className="row d-flex p-3">
                    ...
                    But my coding journey began before than that. While completing an MA in International Affairs, used SQL to analyze and manipulate large datasets related to global development issues. This is
